...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "...") || (event.body.toUllaase() == "...") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
  ...
  if ((event.body.toLowerCase() == "Rakib") || (event.body.toLowerCase() == "Rakib bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Rakib ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rakib:-0140925****);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Sami ッ❤️ তাকে সবাই Rakib নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@নিষ্পাপ") || (event.body.toLowerCase() == "@শয়তান")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রাকিব এর কলিজার আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Picchi") || (event.body.toLowerCase() == "Pori")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস Asif এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Picchi") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা কারণ এটা আমার বস রাকিব তার gf কে বলে ..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "farhana")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাকিব বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Asif ") || (event.body.toLowerCase() == "নিষ্পাপ শয়তান")) {
     return api.sendMessage("🥰-আসিফ-🌺 আমার বস রাকিব'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>Sami_bot", threadID);
   };
   ...
   if ((evAody.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "ami rakib") || (event.body.toLowerCase() == "kire")) {
